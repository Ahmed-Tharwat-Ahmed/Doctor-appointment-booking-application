...
using App.Shared.Helpers.LocalizationContinare;
...
namespace App.Shared.ResponseData
{
    ...
    public class Result<T>
    {
        ...
        public PaginationResponse? Pagination { get; private set; }

        private Result(bool isSuccess, int statusCode, string key, string? message, T? data, PaginationResponse? pagination)
        {
            IsSuccess = isSuccess;
        ...
        public static Result<T> Success(T data, string? successMessageKey = null, PaginationResponse? pagination = null)
        ...
        private static Result<T> CreateResult(bool isSuccess, int statusCode, string key, T? data, string? messageKey, PaginationResponse? pagination)
        {
